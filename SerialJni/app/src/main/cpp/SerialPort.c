 ...
 * Method:    setSpeed
 * Signature: (II)I
 */JNIEXPORT jint JNICALL Java_com_example_gcs_serialjni_serialportapi_SerialPortJNI_setSpeed(
 ...
 * Method:    setParity
 * Signature: (IIII)I
 */JNIEXPORT jint JNICALL Java_com_example_gcs_serialjni_serialportapi_SerialPortJNI_setParity(
 ...
 * Method:    openDev
 * Signature: (I)I
 */JNIEXPORT jobject JNICALL Java_com_example_gcs_serialjni_serialportapi_SerialPortJNI_openDev(
 ...
 * Method:    closeDev
 * Signature: (II)I
 */JNIEXPORT jint JNICALL Java_com_example_gcs_serialjni_serialportapi_SerialPortJNI_closeDev(
 ...
 */JNIEXPORT jint JNICALL Java_com_example_gcs_serialjni_serialportapi_SerialPortJNI_readBytes(
 ...
 */JNIEXPORT jboolean JNICALL Java_com_example_gcs_serialjni_serialportapi_SerialPortJNI_writeBytes(
 ...
 */
JNIEXPORT jobject JNICALL Java_com_example_gcs_serialjni_serialportapi_SerialPortJNI_open485Dev(
        JNIEnv *env, jobject thiz, jstring devnum) {
    return Java_com_example_gcs_serialjni_serialportapi_SerialPortJNI_openDev(env, thiz,
                                                                              devnum);
}
 ...
 */
JNIEXPORT jint JNICALL Java_com_example_gcs_serialjni_serialportapi_SerialPortJNI_close485Dev(
        JNIEnv *env, jobject thiz, jobject mfd) {
    return Java_com_example_gcs_serialjni_serialportapi_SerialPortJNI_closeDev(env, thiz,
                                                                               mfd);
}

JNIEXPORT jint JNICALL Java_com_example_gcs_serialjni_serialportapi_SerialPortJNI_set485mod(
...
jstring
Java_com_example_gcs_serialjni_MainActivity_stringFromJNI(
        JNIEnv *env,
        jobject thiz) {
    jstring hello = "Hello from Cpp";
    return (*env)->NewStringUTF(env, "Hello from Cpp");
}
